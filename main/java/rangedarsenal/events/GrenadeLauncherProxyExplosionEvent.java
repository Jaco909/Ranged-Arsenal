...
public class GrenadeLauncherProxyExplosionEvent extends ExplosionEvent implements Attacker {
    public GrenadeLauncherProxyExplosionEvent() {
        this(0F, 0F, new GameDamage(300.0F,200f), null);
    ...
    public GrenadeLauncherProxyExplosionEvent(float x, float y, GameDamage damage, Mob owner) {
    ...
    protected void playExplosionEffects() {
        ...
        this.level.getClient().startCameraShake(this.x, this.y, 400, 50, 3.0F, 3.0F,false);
    }
}
