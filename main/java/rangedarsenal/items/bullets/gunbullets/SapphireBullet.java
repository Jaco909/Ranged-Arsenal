...
import rangedarsenal.projectiles.bullets.SapphireBulletProjectile;
...
public class SapphireBullet extends BulletItem {
    ...
    public Projectile getProjectile(float x, float y, float targetX, float targetY, float velocity, int range, GameDamage damage, int knockback, Mob owner) {
        return new SapphireBulletProjectile(x, y, targetX, targetY, velocity, range, damage, knockback, owner);
    }
