...
public class BluntBulletProjectile extends BulletProjectile {
    public BluntBulletProjectile() {
    }
    GameDamage ogdamage;
    public BluntBulletProjectile(float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Mob owner) {
