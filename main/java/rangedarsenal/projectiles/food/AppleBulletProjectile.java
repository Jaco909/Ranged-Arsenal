...
public class AppleBulletProjectile extends Projectile {
    private long spawnTime;
    public AppleBulletProjectile(){
    }
    public AppleBulletProjectile(float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Mob owner) {
        this();
