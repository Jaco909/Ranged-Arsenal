...
public class BlackberryBulletProjectile extends Projectile {
    private long spawnTime;
    public BlackberryBulletProjectile(){
    }
    public BlackberryBulletProjectile(float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Mob owner) {
        this();
    ...
    public Color getParticleColor() {
        return new Color(38, 4, 80);
    }
    protected Color getWallHitColor() {
        return new Color(27, 3, 56);
    }
    public Trail getTrail() {
        Trail trail = new Trail(this, this.getLevel(), new Color(111, 90, 134), 15.0F, 150, this.getHeight());
