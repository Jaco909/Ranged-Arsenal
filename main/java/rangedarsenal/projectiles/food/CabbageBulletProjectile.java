...
public class CabbageBulletProjectile extends Projectile {
    private long spawnTime;
    public CabbageBulletProjectile(){
    }
    public CabbageBulletProjectile(float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Mob owner) {
        this();
    ...
    public Color getParticleColor() {
        return new Color(2, 120, 2);
    }
    protected Color getWallHitColor() {
        return new Color(4, 73, 4);
    }
    public Trail getTrail() {
        Trail trail = new Trail(this, this.getLevel(), new Color(75, 141, 75), 25.0F, 150, this.getHeight());
