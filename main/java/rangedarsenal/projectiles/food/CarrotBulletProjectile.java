...
public class CarrotBulletProjectile extends Projectile {

    public float staticAngle;

    public CarrotBulletProjectile(){
    }
    public CarrotBulletProjectile(float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Mob owner) {
        this();
    ...
    public Color getParticleColor() {
        return new Color(231, 85, 5);
    }
    protected Color getWallHitColor() {
        return new Color(133, 50, 4);
    }
    public Trail getTrail() {
        Trail trail = new Trail(this, this.getLevel(), new Color(238, 159, 117), 18.0F, 150, this.getHeight());
