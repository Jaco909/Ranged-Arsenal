...
public class ChilipepperBulletProjectile extends Projectile {

    public float staticAngle;

    public ChilipepperBulletProjectile(){
    }
    public ChilipepperBulletProjectile(float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Mob owner) {
        this();
    ...
    public Color getParticleColor() {
        return new Color(204, 10, 10);
    }
    protected Color getWallHitColor() {
        return new Color(126, 5, 5);
    }
    public Trail getTrail() {
        Trail trail = new Trail(this, this.getLevel(), new Color(232, 134, 134), 25.0F, 150, this.getHeight());
