...
public class CoffeeBulletProjectile extends Projectile {

    public CoffeeBulletProjectile(){
    }
    public CoffeeBulletProjectile(float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Mob owner) {
        this();
    ...
    public Trail getTrail() {
        Trail trail = new Trail(this, this.getLevel(), new Color(79, 67, 61), 17.0F, 150, this.getHeight());
