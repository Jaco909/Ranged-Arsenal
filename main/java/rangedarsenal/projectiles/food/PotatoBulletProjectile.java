...
public class PotatoBulletProjectile extends Projectile {
    private long spawnTime;
    public PotatoBulletProjectile(){
    }
    public PotatoBulletProjectile(float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Mob owner) {
        this();
    ...
    public Trail getTrail() {
        Trail trail = new Trail(this, this.getLevel(), new Color(79, 67, 61), 25.0F, 150, this.getHeight());
