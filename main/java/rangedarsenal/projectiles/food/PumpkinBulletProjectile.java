...
public class PumpkinBulletProjectile extends Projectile {
    private long spawnTime;
    public PumpkinBulletProjectile(){
    }
    public PumpkinBulletProjectile(float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Mob owner) {
        this();
    ...
    public Color getParticleColor() {
        return new Color(255, 96, 12);
    }
    protected Color getWallHitColor() {
        return new Color(169, 62, 4);
    }
    public Trail getTrail() {
        Trail trail = new Trail(this, this.getLevel(), new Color(239, 169, 130), 0.0F, 150, this.getHeight());
