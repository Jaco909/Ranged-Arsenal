...
public class SugarbeetBulletProjectile extends Projectile {

    public float staticAngle;

    public SugarbeetBulletProjectile(){
    }
    public SugarbeetBulletProjectile(float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Mob owner) {
        this();
    ...
    public Color getParticleColor() {
        return new Color(248, 238, 180);
    }
    protected Color getWallHitColor() {
        return new Color(91, 78, 54);
    }
    public Trail getTrail() {
        Trail trail = new Trail(this, this.getLevel(), new Color(255, 236, 201), 18.0F, 150, this.getHeight());
