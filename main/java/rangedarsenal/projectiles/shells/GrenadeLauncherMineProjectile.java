...
import rangedarsenal.events.GrenadeLauncherMineExplosionEvent;

import java.awt.*;
import java.util.List;

public class GrenadeLauncherMineProjectile extends Projectile {
    private long spawnTime;
    public float staticAngle;

    public GrenadeLauncherMineProjectile() {
    }

    public GrenadeLauncherMineProjectile(float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Mob owner) {
        this();
    ...
    public void doHitLogic(Mob mob, LevelObjectHit object, float x, float y) {
        ...
        if (this.isServer()) {
            GrenadeLauncherMineExplosionEvent event = new GrenadeLauncherMineExplosionEvent(x, y, this.getDamage(), this.getOwner());
