...
public class GrenadeLauncherProjectile extends Projectile {
    ...
    public GrenadeLauncherProjectile() {
    }

    public GrenadeLauncherProjectile(float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Mob owner) {
        this();
