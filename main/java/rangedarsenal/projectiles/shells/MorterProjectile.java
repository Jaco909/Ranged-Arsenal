...
public class MorterProjectile extends Projectile {
    private long spawnTime;
    public float staticAngle;
    public MorterProjectile() {
    }

    public MorterProjectile(float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback, Mob owner) {
        this();
